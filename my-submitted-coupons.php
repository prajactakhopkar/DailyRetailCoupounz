		...
		<div class="container-inner"> 
				...
				<div class="row">
						...
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="" href="http://www.dailyretailcouponz.com/write-a-testimonial.php">Write A Testimonial</a>
							</li>
							<li>
											...
											// fetching all the submitted coupons based on username of the session 
												...
												while($row = mysql_fetch_assoc($all_coupons)){
												 ...
												 ?>
													...
													<p><span class="single-deal-expiry"><strong>Expiration Date: </strong><?php echo $row['submitted_coupon_expiry_date']; ?></span></p>
