			...
			<div class="row">
				...
				<!-- menu for all the pages -->
					...
					<div id="myaccountdetails">
						...
						<p><span><?php print $_SESSION['display_name']; ?></span>, we really appreciate your efforts to write a testimonial for us. You can view all testimonials <a href="http://www.dailyretailcouponz.com/testimonial.php">here</a></p>
						</div>
					...
					<div class="myaccount-tabs">
						<ul id="myaccount-tabs-menu" class="myaccount-tabs-menu">
							...
							<li>
								<a class="current-tab" href="http://www.dailyretailcouponz.com/write-a-testimonial.php">Write A Testimonial</a>
							</li>
							<li>
